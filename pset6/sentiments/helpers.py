...
def get_user_timeline(screen_name, count=200):
    ...
    #key auto
    os.environ["API_KEY"] = "YoKqQOidZpIcvlAtgHjL7RxmN"
    os.environ["API_SECRET"] = "nvMCfyeDSLb3QXdqZqGKZsx7KcB62NzxJF4psNB2hILmrfLiai"
    #os.environ["API_KEY"] = "dflsdf34ljlkfjsodf4jrl"
    #os.environ["API_SECRET"] = "dlkfjsdlfj34573485798tedkgjdf45kj"
